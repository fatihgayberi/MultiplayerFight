...
public static class TransformExtensionMethods
{
    ...
    /// <param name="fromTR"></param>
    /// <param name="toTR"></param>
    public static void TransformCopy(this Transform fromTR, WonnaTransformDatas toTR)
    {
        if (fromTR == null)
        {
            return;
...
{
    /// <summary>
    /// vector3 degerin a-b arasından x-y arasına remapler
    /// </summary>
    ...
    /// <returns></returns>
    public static Vector3 Vector3Remap(this Vector3 value, Vector3 from1, Vector3 to1, Vector3 from2, Vector3 to2)
    {
        Vector3 newV3;

        newV3.x = value.x.FloatRemap(from1.x, to1.x, from2.x, to2.x);
        newV3.y = value.y.FloatRemap(from1.y, to1.y, from2.y, to2.y);
        newV3.z = value.z.FloatRemap(from1.z, to1.z, from2.z, to2.z);
...
public static class ColorExtensionMethods
{
    ...
    /// <returns></returns>
    public static Color32 ColorPercentRate(this float percent, Color32 minColor, Color32 maxColor)
    {
...
public static class StringExtensionMethods
{
    ...
    /// </summary>
    /// <param name="strMessage"> string mesajı </param>
    /// <returns></returns>
    public static bool IsStringNullOrWhiteSpace(this string strMessage)
    {
        return string.IsNullOrWhiteSpace(strMessage);
    }
...
public static class UnitConversionExtensionMethods
{
    ...
    /// <param name="second"> artık saniye </param>
    /// <returns></returns>
    public static float Minute2Second(float minute, float second = 0)
    {
        return (minute * 60f) + second;
    }
...
#region "Matematik hesaplamalar ile ilgili metodlar"
public static class MathExtensionMethods
{
    /// <summary>
    /// verilen sayinin yüzdesini hesaplar
    /// </summary>
    /// <param name="num"></param>
    /// <param name="percentage"></param>
    /// <returns></returns>
    public static float GetPercentageOfNumber(this float num, float percentage)
    {
...
public static class GeometricExtensionMethods
{
    ...
    /// <returns></returns>
    public static float TargetAngleDistance(this Vector2 startPos, Vector2 targetPos)
    {
        float AngleRad = Mathf.Atan2(targetPos.y - startPos.y, targetPos.x - startPos.x);
