...
{
    public class WonnaTest2 : MonoBehaviour
    {
        [Space(), Space()]
        ...
        [SerializeField][Range(0, 1)] private float scaleRate;
        ...
        public void ThrowInitialize(float angle, float distanceHorizantal, Vector3 targetPos)
        {
            _isThrow = true;
        ...
        private void Throw()
        {
            ...
            if (_tempDuration <= duration / 2)
            {
                ...
                _tempScaleRate = _tempDuration.FloatRemap(0, duration / 2, 1, scaleRate);
            }
            else
            {
                // aşagi düşüyor

                _tempScaleRate = _tempDuration.FloatRemap(duration / 2, duration, scaleRate, 1);
            }
